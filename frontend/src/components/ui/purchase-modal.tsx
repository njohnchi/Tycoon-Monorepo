  ...
  return (
    ...
    >
      <Card className="w-full max-w-md border-neutral-800 bg-neutral-900 shadow-2xl">
        <CardHeader>
          <CardTitle id="modal-title" className="text-xl text-white">
            {t('shop.confirm_purchase')}
          </CardTitle>
          <CardDescription id="modal-description" className="text-neutral-400">
        ...
        <CardFooter className="flex justify-end gap-3">
          ...
          <Button onClick={onConfirm} className="bg-cyan-500 text-black hover:bg-cyan-400">
            {t('shop.purchase')}
          </Button>
        </CardFooter>
      </Card>
